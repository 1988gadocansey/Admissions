      ...
      items: [
        {
          ...
          children: [
            ...
            { label: 'Educational Background', route: '/stepfour/educationalbackground', },
            { label: 'Upload of Result', route: '/stepfive/results', },
            { label: 'Research Information', route: '/graduate/research', },
            { label: 'List of Referees', route: '/graduate/referees', },
            { label: 'Supporting Documents', route: '/graduate/documents', },
