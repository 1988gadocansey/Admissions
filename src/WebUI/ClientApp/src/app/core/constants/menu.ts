import { AddressClient, HomeClient, UserDto } from 'src/app/web-api-client';
import { MenuItem } from '../models/menu.model';

export class Menu {
  public static menuData: MenuItem[] = [];
  public menu: any;
  constructor() {
  ...
  getMenu(): any {
    ...
    console.log("the form", localStorage.getItem('menus'))
  ...
  static getMenuData(): MenuItem[] {
    if (localStorage.getItem('menus') == "BTECH") {
    ...
    else if (localStorage.getItem('menus') == "HND") {
    ...
    else if (localStorage.getItem('menus') == "ACCELERATED") {
